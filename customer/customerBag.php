            ...
            <form action="../customer-database/cartPurchaseDB.php" method="GET">
              ...
              INNER JOIN product_tbl ON cart_tbl.prod_ID = product_tbl.prod_ID WHERE cart_tbl.customer_ID = $customerID;");
                  ...
                  <div class="d-flex justify-content-center">
                    ...
                    <button type='button' data-bs-toggle="modal" data-bs-target="#orderConfirmation" class="btn btn-dark px-5 py-2 rounded-5">Place Order</button>
                  </div>
                </div>
              </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="modal-title text-center text-success fw-bold">
                        Confirm Purchase?
                      </div>
                    </div>
