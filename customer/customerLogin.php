    ...
    <div class="container-fluid mt-3 d-flex flex-column align-items-center">
      <form action="../customer-database/loginDB.php" method="POST">
        <div class="form-outline mb-3">
          ...
          <input type="text" class="form-control rounded-4 py-2 bg-transparent border-2" name="email" id="email" />
        </div>

        <div class="form-outline">
          <label for="password" class="form-label">Password</label>
          <input type="password" class="form-control rounded-4 py-2 mb-4 bg-transparent border-2" name="password" id="password" required />
        </div>
        <button type="submit" name="loginBtn" class="login py-2 w-100 mt-2 rounded-4">
          Log in
        </button>
      </form>
    </div>
    <a class="toSignUp mt-3 text-white" href="forgotPassword.php">
      Forgot Password?</a>
