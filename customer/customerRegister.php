                ...
                <div class="row mt-2">
                    <div class="col-lg-6 mt-2">
                        <div class="form-outline">
                            ...
                            <input type="email" class="form-control rounded-4 py-2 bg-transparent border-2" name="email"
                                id="email">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mt-2">
                        <div class="form-outline">
                            ...
                            <input type="text" class="form-control rounded-4 py-2 bg-transparent border-2"
                ...
                <div class="row mt-2">
                    <div class="col-lg-6">
                        <div class="form-outline">
                            ...
                            <input type="number" class="form-control rounded-4 py-2 bg-transparent border-2"
                ...
                <div class="row mt-2">
                    <div class="col-lg-6">
                        <div class="form-outline">
                            ...
                            <input type="password" class="form-control rounded-4 py-2 bg-transparent border-2"
