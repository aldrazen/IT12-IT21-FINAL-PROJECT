            ...
            <form action="../customer-database/customerUpdateDB.php" method="POST">
                        ...
                        <div class="row d-flex justify-content-around row-gap-3 mx-3 my-4">
                            <div class="col-lg-5">
                                <div class="row d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="col-lg-9 m-0 p-0">
                                        <input type="text" class="form-control rounded-4 border-2" name="email"
                            ...
                            <div class="col-lg-5">
                                <div class="row d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="col-lg-9 m-0 p-0">
                                        <input type="text" class="form-control rounded-4 border-2" name="fullname"
                                            id="fullname" value="<?php echo $_SESSION['fullname'] ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-5">
                                <div class="row  d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="col-lg-9 m-0 p-0">
                                        <input type="password" class="form-control rounded-4 border-2" name="password"
                                            id="password">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="row  d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="col-lg-9 m-0 p-0">
                                        <input type="password" class="form-control rounded-4 border-2"
                            ...
                            <div class="col-lg-5">
                                <div class="row  d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="col-lg-9 m-0 p-0">
                                        <input type="text" class="form-control rounded-4 border-2 " name="phoneNumber"
                                            id="phoneNumber" value="<?php echo $_SESSION['number'] ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-10">
                                <div class="row align-items-center m-0 p-0">
                                    ...
                                    <div class="col-lg-10 m-0 p-0">
                                        <input type="text" class="form-control rounded-4 border-2 " name="address"
                                            id="address" value="<?php echo $_SESSION['address'] ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mt-4">
                    <div class="col-12 text-end">
                        ...
                        <button class="btn btn-dark mx-2 rounded-3" type="button" data-bs-toggle="modal"
                                ...
                                <div class="row">
                                    <div class="col pt-3">
                                        <div class="col-lg mb-2 p-0">
                                            ...
                                            <input type="email" class="form-control rounded-4 border-2"
                                                name="current_email" id="current_email"
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="col-lg bi bi-instagram fs-3 text-white">
                        <a href="https://www.instagram.com/topshelf.23/" target="_blank"
                            class="social-media">topshelf.23
                        </a>
                    </div>
                    <div class="col-lg bi bi-tiktok fs-3 text-white">
                        <a href="https://www.tiktok.com/@topshelfco_" target="_blank"
                            class="social-media">topshelfco_</a>
                    </div>
                </div>
            </div>
