      ...
      <nav class="col-md-2 d-none d-md-block bg-light sidebar bg-black">
        ...
        <div class="sidebar-sticky d-flex flex-column position-relative">
          <ul class="nav flex-column mt-5  mx-2">
            ...
            <li class="nav-item">
              <a class="nav-link activee" href="customers.php">CUSTOMERS</a>
            </li>
          </ul>
        ...
        <div class="container d-flex flex-column justify-content-center align-items-center">
          <table class="table text-center">
            ...
            <tbody>
              <?php
              include'../admin-database/connectionDB.php';
              $customer_query = mysqli_query($connection,"SELECT customer_ID, customer_name, customer_number, customer_address FROM customer_tbl");
              while($customer_row = mysqli_fetch_assoc($customer_query)){
                $customerID = $customer_row['customer_ID'];
                $customerName = $customer_row['customer_name'];
                $customerNumber = $customer_row['customer_number'];
                $customerAdd = $customer_row['customer_address'];
                echo" <tr>
                <td>$customerID</td>
                <td>$customerName</td>
